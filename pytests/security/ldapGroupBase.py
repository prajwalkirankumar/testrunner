...
class ldapGroupBase:
    ...
    def add_role_group(self, group_name, roles, ldap_ref, host):
        print "Group name -- {0} :: Roles -- {1} :: LDAP REF -- {2}".format(group_name, roles, ldap_ref)
        rest = RestConnection(host)
        ...
        print "Output of adding group to roles is {0} - {1}".format(status, content)
    ...
    def add_int_user_role(self, user, group_name, host):
        ...
        print "Output of adding internal user to roles is {0} - {1}".format(status, content)
        return content
    ...
    def remove_int_user_role(self, user, group_name, host):
        ...
        User_roles = literal_eval(content[1])
